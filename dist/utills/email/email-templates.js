...
<body>
    <div class="container">
        ...
        <p>Dear Team,</p>
        <p>A new quotation has been received from ${data.supplierName} (${data.supplierEmail}) for ${data.qty} units of item ID ${data.item}.</p>
...
const OrderCreatedEmail = (data) => {
  ...
  <body>
      <div class="container">
          ...
          <p>Dear ${data.fullName},</p>
          <p>Thank you for your order!</p>
          <p>Your order <strong>ID: ${data.orderId}</strong> has been successfully created on <strong>${new Date(data.orderDate).toLocaleDateString()}</strong>.</p>
...
const HallBookingSuccessEmail = (data) => {
    return `
  <!DOCTYPE html>
  <html>
  <head>
  ...
  <body>
      <div class="container">
          ...
          <p>Your hall booking <strong>ID: ${data.bookingId}</strong> has been successfully created on <strong>${new Date(data.bookingDate).toLocaleDateString()}</strong>.</p>
