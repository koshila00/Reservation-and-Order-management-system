...
export default function OrchidHall() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (
        ...
        formData.hallBookingGuestCount > 251
      ) {
        showAlert(
          "Please fill in all required fields and ensure guest count is between 10 and 250",
          "warning"
        );
        return;
      }
      ...
      const hallBookingTotal = 250000 + formData.hallBookingGuestCount * price - ((formData.hallBookingGuestCount * price) * (discountValue / 100));
  ...
  useEffect(() => {
    if (discounts.length > 0) {
      ...
      const randomDiscountId = discounts[randomIndex].discountId;
      setFormData((prevData) => ({
        ...prevData,
        discountId: randomDiscountId,
      }));
    }
  }, [discounts]);
