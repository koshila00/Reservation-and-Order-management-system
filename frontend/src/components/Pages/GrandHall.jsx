  ...
  const handleSubmit = async () => {
    try {
      ...
      if (
        ...
        formData.hallBookingGuestCount > 351
      ) {
        showAlert(
          "Please fill in all required fields and ensure guest count is between 10 and 350",
          "warning"
        );
        return;
      }
      ...
      const hallBookingTotal = 400000 + formData.hallBookingGuestCount * price - ((formData.hallBookingGuestCount * price) * (discountValue / 100));
